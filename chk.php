...
require_login(); // 🚫 si no está logueado, redirige a index.php
?>
<!DOCTYPE php>
<php lang="es">
<head>
...
<body class="p-3">
    ...
    <div class="container text-white rounded shadow p-3 my-4">
        <div class="header-container">
            ...
            <p><a class="btn btn-warning" href="logout.php">Cerrar sesión</a></p>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="chk-home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class="container-fluid p-0 mt-3">
                    ...
                    <textarea id="lista_cartoes" placeholder="Insira sua lista no formato: NÚMERO|MES|ANO|CVV" data-i18n-placeholder="card_placeholder" rows="10" class="rounded shadow"></textarea>
                </div>
            </div>
    ...
    <script>
        ...
        const translations = {
            es: {
                ...
                "card_placeholder": "Insira sua lista no formato: NÚMERO|MES|ANO|CVV",
                "copy": "Copiar",
        ...
        // Función auxiliar para obtener traducciones en el código JavaScript
